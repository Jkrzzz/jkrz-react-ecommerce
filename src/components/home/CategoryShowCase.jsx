        ...
        <div className="section-header">
          ...
          <div className="course-filter-group">
            <ul className="lab-ul">
              ...
              <li onClick={() => filteredItems("Shoes")}>Shoes</li>
              <li onClick={() => filteredItems("Bags")}>Bags</li>
              <li onClick={() => filteredItems("Phones")}>Phones</li>
              <li onClick={() => filteredItems("Beauty")}>Beauty</li>
            </ul>
          </div>
        </div>
