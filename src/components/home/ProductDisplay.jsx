...
const desc =
  "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aperiam magnam, eos molestiae magni earum veniam officia in tenetur ea facilis minima excepturi laboriosam modi amet molestias harum? Id, praesentium doloribus.";
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="cart-plus-minus">
            ...
            <input
              ...
              value={prequantity}
              onChange={(e) => {
                setPrequantity(parseInt(e.target.value, 10));
              }}
            />
